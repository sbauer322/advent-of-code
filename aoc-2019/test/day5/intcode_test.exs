defmodule AOC.Day5.IntcodeTest do
  ...
  test "valid program with negative numbers" do
    ...
    outputs = Intcode.puzzle_input_to_map(input)
      |> Intcode.compute()
  ...
  test "If input is 8, output is 1. Otherwise 0." do
    ...
    user_input = [8]
    outputs = Intcode.puzzle_input_to_map(puzzle_input, user_input)
              |> Intcode.compute()
    assert [1] == outputs
  ...
  test "part 1" do
    user_input = [1]
    last_output = Intcode.part1("./resources/day5_part1_input.txt", user_input)
                   |> Enum.reverse()
                   |> hd()
  ...
  test "part 2" do
    user_input = [5]
    last_output = Intcode.part2("./resources/day5_part1_input.txt", user_input)
                  |> Enum.reverse()
                  |> hd()
