defmodule AOC.Day11.IntcodeTest do
  ...
  test "part 1" do
    #    {_state, memory} = Intcode.part1("./resources/day11_part1_input.txt", [1])
    #    assert [2_682_107_844] == Intcode.read_outputs(memory)
  end

  test "part 2" do
    #    {_state, memory} = Intcode.part2("./resources/day11_part1_input.txt", [2])
